 ...
 */
@WebServlet(name = "servletListadoClientes", urlPatterns = {"/servletListadoClientes"})
public class servletListadoClientes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servletListadoClientes</title>");  
            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Listado de clientes aqui</h1>");
